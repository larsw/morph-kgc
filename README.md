...
- Input data formats:
    ...
    - **Cloud data lake solutions**: [Databricks](https://www.databricks.com/), [Snowflake](https://www.snowflake.com/), [Spark SQL](https://spark.apache.org/sql/) (including Iceberg-backed catalogs/tables).
